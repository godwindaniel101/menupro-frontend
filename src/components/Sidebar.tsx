		...
		<Drawer isOpen={openSidebar} setIsOpen={setOpenSidebar}>
			<div className="w-full h-full flex items-end py-12 px-6">
				<div className="flex flex-col gap-4">
					<h3 className="font-bold text-[18px] text-neutral-100">
						Get in touch
					</h3>

					<p className="flex items-center gap-2 cursor-pointer text-[15px] text-neutral-200">
					...
					<div className="flex items-center gap-4">
						...
						{menu_details?.email && (
							<a
								...
								target="_blank"
								className="text-[30px] text-neutral-200">
								<MdEmail />
							</a>
						)}
